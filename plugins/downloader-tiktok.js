...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'Ɲ4MЄƇƖƬ4_ƁƇ', body: null, thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/n4mecit4_bc/'}, mentionedJid: [m.sender]}}}, aa);
