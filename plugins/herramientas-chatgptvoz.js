...
const sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por BrunoSobrino, tu seras Ɲ4MЄƇƖƬ4_ƁƇ - Bot.`;
...
handler.command = /^(openaivoz|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|Jossvoz|JossBotvoz|gptvoz|ai_voz|ai_voce)$/i;
